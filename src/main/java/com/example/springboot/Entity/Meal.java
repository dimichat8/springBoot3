...
public class Meal {
    ...
    @ElementCollection
    @CollectionTable(name = "MealGrams", joinColumns = @JoinColumn(name = "meal_id"))
    @Column(name = "grams")
    private List<Integer> mealGrams;

    public Meal(Long meal_id, String mealName, String dayOfWeek, List<String> breakfast, List<String> desert, List<String> lunch, List<String> snack, List<String> dinner, List<Food> foods, Customer customer, MealPlan mealPlan, LocalDate dateFrom, LocalDate dateTo, List<Integer> mealGrams) {
    ...
    public List<Integer> getMealGrams() {
        return mealGrams;
    }

    public void setMealGrams(List<Integer> mealGrams) {
        this.mealGrams = mealGrams;
    }
}
